...
export default function Home() {
  ...
  return <div className="landing">
    ...
    <main>
      ...
      <section id="walkthrough" className="walkthrough-section"><div><span className="eyebrow">04 / TWO MINUTES, THIRTY SECONDS</span><h2>See a failure.<br/>Understand the fix.</h2><p>A narrated, captioned walkthrough of computed replay reports and onchain receipts.</p><a className="text-link" href="https://github.com/Nakshatra05/windtunnel">Read the code <ArrowUpRight size={18}/></a></div><video controls preload="metadata" poster="/demo/replay-report.png" aria-label="WindTunnel narrated project walkthrough"><source src="/demo/windtunnel-demo.mp4?v=voiceover-1" type="video/mp4"/></video></section>
